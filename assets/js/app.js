...
var theaters = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      ...
      var galerie =   "<img style='margin: 10px 0px' src='/img/" + feature.properties.IMG +"/1.JPG'  height='auto' max-width: 100%; class='img-responsive img-thumbnail'>" + "<img style='margin: 10px 0px' src='/img/" + feature.properties.IMG +"/2.JPG' height='auto' max-width: 100%; class='img-responsive img-thumbnail'>" + "<img style='margin: 10px 0px' src='/img/" + feature.properties.IMG +"/3.JPG' height='auto' max-width: 100%; class='img-responsive img-thumbnail'>" + "<img style='margin: 10px 0px' src='/img/" + feature.properties.IMG +"/4.JPG' height='auto' max-width: 100%; class='img-responsive img-thumbnail'>" + "<img style='margin: 10px 0px' src='/img/" + feature.properties.IMG +"/5.JPG' height='auto' max-width: 100%; class='img-responsive img-thumbnail'>";
      layer.on({
        click: function (e) {
