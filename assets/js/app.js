...
var theaters = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<div style='font-size: 16px; margin:2px; padding: 1em 1em 1em 1em;' class='bg-success'><i>" + feature.properties.INFO + "</i></div>" + "<br></br>" +"<div class='panel panel-info'>" +
