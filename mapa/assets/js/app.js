...
var mapquestOAM = L.tileLayer("http://{s}.mqcdn.com/tiles/1.0.0/osm/{z}/{x}/{y}.png", {
    ...
    mapquestOSM =  L.tileLayer('http://{s}.{base}.maps.cit.api.here.com/maptile/2.1/maptile/{mapID}/normal.day.custom/{z}/{x}/{y}/256/png8?app_id={app_id}&app_code={app_code}', {
    ...
    mapquestHYB = L.tileLayer("http://{s}.{base}.maps.cit.api.here.com/maptile/2.1/maptile/{mapID}/hybrid.day.mobile/{z}/{x}/{y}/256/png8?app_id={app_id}&app_code={app_code}", {
        attribution: 'Map &copy; 1987-2014 <a href="http://developer.here.com">HERE</a>',
        subdomains: "1234",
        mapID: "newest",
        app_id: "qpmQayVMDvid7tmL0dlT",
...
var markerClusters = new L.MarkerClusterGroup({
    ...
    theaters = L.geoJson(null, {
        pointToLayer: function(e, t) {
            return L.marker(t, {
                icon: L.divIcon({
                    html: "<table><tr><th style='font-size:13px;' class='label label-danger'>" + e.id + "</th></tr><tr><td><img  src='assets/img/hriste.png' width='26' height='30'></td></tr></table>",
                    iconSize: [14, 14],
                    iconAnchor: [12, 28],
        ...
        onEachFeature: function(e, t) {
            if (e.properties) {
                var a = "<div style='font-size: 17px; margin:2px; padding: 1em 1em 1em 1em;' class='bg-primary' role='alert'>" + e.properties.INFO + "</div><br></br></div><div class='panel panel-info'><div class='panel-heading'><h3 class='panel-title'>Popis</h3></div><div class='panel-body'>" + e.properties.POPIS + "</div></div><div class='panel panel-info'><div class='panel-heading'><h3 class='panel-title'>Doporučujeme</h3></div><div class='panel-body'>" + e.properties.DOPORUCENI + "</div></div><div class='panel panel-info'><div class='panel-heading'><h3 class='panel-title'>Sociální zařízení</h3></div><div class='panel-body'>" + e.properties.SOCIALNI + "</div></div><div class='panel panel-info'><div class='panel-heading'><h3 class='panel-title'>Občerstvení</h3></div><div class='panel-body'>" + e.properties.OBCERSTVENI + "</div></div><div class='panel panel-info'><div class='panel-heading'><h3 class='panel-title'>Doprava</h3></div><div class='panel-body'>" + e.properties.DOPRAVA + "</div></div>",
                ...
                t.on({
                    click: function() {
                        ...
                        $("#feature-gal").html(o), $(document).ready(function() {
                            $("obr").each(function(t) {
                                $(this).prepend("<center><a href='../old_mapa/img/" + e.id + "/" + ++t + ".JPG' target='_blank'><img style='margin: 10px 0px' src='../old_mapa/img/" + e.id + "/" + t + ".JPG'  height='auto' max-width: 100%; class='img-responsive img-thumbnail' /></a></center>")
                            })
...
$.getJSON("../old_mapa/data/hriste.geojson", function(e) {
